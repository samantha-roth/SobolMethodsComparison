...
k=1
  ...
  save(Rho_sum_AKMCS,Rho_AKMCS,file=paste0(folder,"/AKMCS/Rho"))
  save(Weights_AKMCS,Weights_sum_AKMCS,file=paste0(folder,"/AKMCS/Weights"))
  ...
  save(Rho_sum_BASS,Rho_BASS,file=paste0(folder,"/BASS_mmESS/Rho"))
  save(Weights_BASS,Weights_sum_BASS,file=paste0(folder,"/BASS_mmESS/Weights"))
  ...
  save(Rho_sum_Kriging,Rho_Kriging,file=paste0(folder,"/Kriging/Rho"))
  save(Weights_Kriging,Weights_sum_Kriging,file=paste0(folder,"/Kriging/Weights"))
...
k=1
  ...
  load(paste0(folder,"/AKMCS/Rho"))
  all_Rho_AKMCS_node0<- Rho_sum_AKMCS
  
  #BASS

  load(paste0(folder,"/BASS_mmESS/Rho"))
  all_Rho_BASS_node0<- Rho_sum_BASS
  
  #Kriging

  load(paste0(folder,"/Kriging/Rho"))
...
for(node in 1:(n_nodes-1)){
  ...
  k=1
    ...
    Rho_sum_AKMCS<- sum(Rho_AKMCS)
    save(Rho_sum_AKMCS,Rho_AKMCS,file=paste0(folder,"/AKMCS/seed",seed,"/Rho"))
    save(Weights_AKMCS,Weights_sum_AKMCS,file=paste0(folder,"/AKMCS/seed",seed,"/Weights"))
    ...
    Rho_sum_BASS<- sum(Rho_BASS)
    save(Rho_sum_BASS,Rho_BASS,file=paste0(folder,"/BASS_mmESS/seed",seed_BASS,"/Rho"))
    save(Weights_BASS,Weights_sum_BASS,file=paste0(folder,"/BASS_mmESS/seed",seed_BASS,"/Weights"))
    ...
    Rho_sum_Kriging<- sum(Rho_Kriging)
    save(Rho_sum_Kriging,Rho_Kriging,file=paste0(folder,"/Kriging/seed",seed,"/Rho"))
    save(Weights_Kriging,Weights_sum_Kriging,file=paste0(folder,"/Kriging/seed",seed,"/Weights"))
...
for(node in 1:(n_nodes-1)){
  ...
  k=1
    ...
    load(paste0(folder,"/AKMCS/seed",seed,"/Rho"))
    all_Rho_AKMCS[node+1]<- Rho_sum_AKMCS
    
    #BASS

    load(paste0(folder,"/BASS_mmESS/seed",seed_BASS,"/Rho"))
    all_Rho_BASS[node+1]<- Rho_sum_BASS
    
    #Kriging

    load(paste0(folder,"/Kriging/seed",seed,"/Rho"))
...
save(all_Rho_AKMCS,file=paste0(folder,"all_Rho_AKMCS"))
save(all_Rho_BASS,file=paste0(folder,"all_Rho_BASS"))
save(all_Rho_Kriging,file=paste0(folder,"all_Rho_Kriging"))

save(min_Rho_AKMCS,mean_Rho_AKMCS,max_Rho_AKMCS,file=paste0(folder,"/summary_Rho_AKMCS"))
save(min_Rho_BASS,mean_Rho_BASS,max_Rho_BASS,file=paste0(folder,"/summary_Rho_BASS"))
save(min_Rho_Kriging,mean_Rho_Kriging,max_Rho_Kriging,file=paste0(folder,"/summary_Rho_Kriging"))
