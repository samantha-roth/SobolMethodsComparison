...
pdf(file = "./Sam_Figures/Figure_Timescale_MeanBest_Poly.pdf",width = 12,height = 7)
par(mar=c(5,5,2.6,6))
...
pdf(file = "./Sam_Figures/MeanFastestAcrossAllSeeds_Poly.pdf",width = 12,height = 7)
par(mar=c(5,5,2.6,6))
plot(textMat_meanBest[nrow(textMat_meanBest):1, ],breaks = c("Sobol","AKMCS",
                                                             "BASS","Kriging","None"),
     xlab="Time of single run",ylab="Number of input parameters",col=cols,
     cex.lab=1.5,cex.axis=1,main="")
dev.off()
