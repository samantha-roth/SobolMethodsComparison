...
load(paste0(folder,"all_Rho_AKMCS"))
load(paste0(folder,"all_Rho_BASS"))
load(paste0(folder,"all_Rho_Kriging"))
...
#no consistent best or worst. all < 0.7
...
#For both: AKMCS by far the worst (never <1), BASS in middle, Kriging best
