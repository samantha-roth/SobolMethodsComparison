...
save(Time_Sobol,file=paste0("./Ranking_Data/Hymod/Time_Sobol_node0"))
save(Time_BASS,file=paste0("./Ranking_Data/Hymod/Time_BASS_node0"))
save(Time_Kriging,file=paste0("./Ranking_Data/Hymod/Time_Kriging_node0"))
save(Time_AKMCS,file=paste0("./Ranking_Data/Hymod/Time_AKMCS_node0"))
...
for(node in 1:n_nodes){
  ...
  i=1
    ...
    # BASS:
    load(paste0(folder, "/BASS_mmESS/seed",seed_BASS,"/T_BASS"))
    load(paste0(folder, "/BASS_mmESS/seed",seed_BASS,"/T_pred_BASS"))
    load(paste0(folder, "/BASS_mmESS/seed",seed_BASS,"/T_LHS_BASS"))
    load(paste0(folder, "/BASS_mmESS/seed",seed_BASS,"/T_check_BASS"))
    load(paste0(folder,"/BASS_mmESS/seed",seed_BASS,"/T_BASSSobol"))
    #load(paste0(folder,"/BASS_mmESS/seed",seed_BASS,"/S_BASS_list"))
    load(paste0(folder,"/BASS_mmESS/seed",seed_BASS,"/BASS_size"))
  ...
  save(Time_Sobol,file=paste0("./Ranking_Data/Hymod/Time_Sobol_node",node))
  save(Time_BASS,file=paste0("./Ranking_Data/Hymod/Time_BASS_node",node))
  save(Time_Kriging,file=paste0("./Ranking_Data/Hymod/Time_Kriging_node",node))
  save(Time_AKMCS,file=paste0("./Ranking_Data/Hymod/Time_AKMCS_node",node))
